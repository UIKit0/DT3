...
class ComponentDrawImagePlane: public ComponentBase {
    public:
        ...
        virtual void                archive_read                (const std::shared_ptr<Archive> &archive);
        virtual void                archive_write               (const std::shared_ptr<Archive> &archive);
	...
	public:
		...
		virtual void                        add_to_owner        (const std::shared_ptr<ObjectBase> &owner);
