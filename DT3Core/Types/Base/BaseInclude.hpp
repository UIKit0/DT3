...
struct DTclasskind {
	DTclasskind(const DTclasskind *super_class, const DTcharacter *class_name)
	:	super	(super_class),
		name	(class_name)
	{}
	
	const DTclasskind	*super;
	const DTcharacter	*name;
};

#define DEFINE_TYPE_BASE(cid)	\
	typedef cid type;                                                                                                                           \
	inline static const DTcharacter*    class_id_static (void)         	{   return static_cast<const DTcharacter*>(#cid);                   }   \
	inline virtual const DTcharacter*   class_id_child (void) const		{   return class_id_static();                                       }   \
	inline const DTcharacter*           class_id (void) const         	{   return class_id_static();                                       }   \
	inline static const DTclasskind*    kind (void)						{	static const DTclasskind kind(NULL, class_id_static());             \
                                                                            return &kind;                                                   }	\
	inline virtual DTboolean            isa (const DTclasskind* k) const{	return k == kind();                                             }   \
...
#define DEFINE_TYPE(cid,sid) \
	...
	inline virtual const DTcharacter*   class_id_child (void) const		{   return class_id_static();                                       }   \
	inline const DTcharacter*           class_id (void) const         	{   return class_id_static();                                       }   \
	inline static const DTclasskind*    kind (void)						{	static const DTclasskind kind(super_type::kind(), class_id_static());     \
                                                                            return &kind;                                                   }	\
	inline virtual DTboolean            isa (const DTclasskind* k) const{	const DTclasskind *cur = kind();                                    \
                                                                            while (cur) {                                                       \
...
#define DEFINE_TYPE_SIMPLE_BASE(cid) \
	...
	inline static const DTcharacter*    class_id_static (void)         	{   return static_cast<const DTcharacter*>(#cid);                   }   \
	inline const DTcharacter*           class_id (void) const         	{   return class_id_static();                                       }   \
	inline const DTcharacter*           class_id_child (void) const		{   return class_id_static();                                       }   \
	inline static const DTclasskind*    kind (void)						{	static const DTclasskind kind(NULL, class_id_static());             \
                                                                            return &kind;                                                   }
