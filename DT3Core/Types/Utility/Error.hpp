...
//==============================================================================
    ...
    #define ERROR(cond, msg)    if (!(cond))        ErrorImpl::call_error_msg   (__FILE__, __FUNCTION__, __LINE__, msg)
#else
    #define ERROR(cond, msg)    if (!(cond))        ErrorImpl::call_error_msg   (__FILE__, __func__, __LINE__, msg)
#endif


#if DT3_OS == DT3_WINDOWS
    #define ERRORMSG(msg)       ErrorImpl::call_error_msg (__FILE__, __FUNCTION__, __LINE__, msg)
#else
    #define ERRORMSG(msg)       ErrorImpl::call_error_msg (__FILE__, __func__, __LINE__, msg)
#endif


#if DT3_OS == DT3_WINDOWS
    #define WARNING(cond, msg)  if (!(cond))        ErrorImpl::call_warning_msg (__FILE__, __FUNCTION__, __LINE__, msg)
#else
    #define WARNING(cond, msg)  if (!(cond))        ErrorImpl::call_warning_msg (__FILE__, __func__, __LINE__, msg)
#endif


#if DT3_OS == DT3_WINDOWS
    #define WARNINGMSG(msg)     ErrorImpl::call_warning_msg (__FILE__, __FUNCTION__, __LINE__, msg)
#else
    #define WARNINGMSG(msg)     ErrorImpl::call_warning_msg (__FILE__, __func__, __LINE__, msg)
#endif
