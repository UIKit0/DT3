...
#define PLUG_OFFSET(Plug)			(	reinterpret_cast<DTubyte*>(static_cast<PlugBase*>(&(reinterpret_cast<type*>(0x99999999)->Plug))) - \
										reinterpret_cast<DTubyte*>(static_cast<PlugNode*>(reinterpret_cast<type*>(0x99999999)))	)
